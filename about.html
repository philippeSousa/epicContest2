		...
		<div class="container">
			...
			<div class="about-info">
				...
				<div class="col-md-7 about-info-right">
					...
					injected humour, or non-characteristic words etc.Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour,  to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition</p>
				</div>
				<div class="clearfix"> </div>
			</div>
